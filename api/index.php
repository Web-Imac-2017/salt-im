...
$router->addRule('media/get/:id', array('controller' => 'media', 'action' => 'index'));
$router->addRule('media/:id/img', array('controller' => 'media', 'action' => 'img'));
$router->addRule('p/post/add', array('controller' => 'post', 'action' => 'add'));
$router->addRule('p/get/:id', array('controller' => 'post', 'action' => 'index'));
...
$router->addRule('u/autologin', array('controller' => 'user', 'action' => 'login'));
